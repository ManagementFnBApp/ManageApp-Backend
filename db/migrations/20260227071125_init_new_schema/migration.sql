...
CREATE TABLE "shift_staffs" (
    ...
    CONSTRAINT "shift_staffs_pkey" PRIMARY KEY ("shift_id","user_id")
);
...
CREATE TABLE "ShopCategory" (
    ...
    CONSTRAINT "ShopCategory_pkey" PRIMARY KEY ("shop_id","category_id")
);
...
-- AddForeignKey
ALTER TABLE "shift_staffs" ADD CONSTRAINT "shift_staffs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ShopCategory" ADD CONSTRAINT "ShopCategory_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "shops"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShopCategory" ADD CONSTRAINT "ShopCategory_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "subscription_payments" ADD CONSTRAINT "subscription_payments_sub_tenant_id_fkey" FOREIGN KEY ("sub_tenant_id") REFERENCES "shop_subscriptions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
