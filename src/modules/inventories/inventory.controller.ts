...
export class InventoryController {
    ...
    @Get()
    findAll(@Query('shopId', new ParseIntPipe({ optional: true })) shopId?: number) {
    ...
    @Get('items/all')
    findAllItems(
        @Query('inventoryId', new ParseIntPipe({ optional: true })) inventoryId?: number,
    ...
    @Patch('items/:id')
    updateItem(@Param('id', ParseIntPipe) id: number, @Body() updateInventoryItemDto: UpdateInventoryItemDto) {
